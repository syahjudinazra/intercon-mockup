<template>
  <CRow>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/button.html">
            <template v-for="state in ['normal', 'active', 'disabled']" :key="state">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>with icons</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>Button components</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
          ...
          <p class="text-body-secondary small">
            ...
            <code>&lt;a&gt;</code> elements that are used to trigger functionality ex. collapsing
            content, these links should be given a <code>role=&#34;button&#34;</code> to adequately
            communicate their meaning to assistive technologies such as screen readers.
          </p>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>outline</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>ghost</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>Sizes</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>Pill</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>Square</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>Disabled state</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
          ...
          <p class="text-body-secondary small">
            ...
            has to add <code>.disabled</code> class to make buttons look inactive. CoreUI also has
            to add to the disabled button component
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Button</strong> <small>Block buttons</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
