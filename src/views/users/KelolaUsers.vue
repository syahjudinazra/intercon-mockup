      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-body-secondary small">
            ...
            sides of an input. Remember to place
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-body-secondary small">
            ...
            <code>&lt;CInputGroup&gt;</code> itself and contents within will automatically resize—no
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/input-group.html#button-addons">
            <CInputGroup class="mb-3">
              <CButton id="button-addon1" type="button" color="secondary" variant="outline">
                Button
              </CButton>
              <CFormInput
                placeholder=""
            ...
            <CInputGroup class="mb-3">
              ...
              />
              <CButton id="button-addon2" type="button" color="secondary" variant="outline">
                Button
              </CButton>
            </CInputGroup>
            <CInputGroup class="mb-3">
