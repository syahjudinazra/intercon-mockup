<template>
  <CRow>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Form Control</strong> <small>Sizing</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Form Control</strong> <small>Disabled</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Form Control</strong> <small>Readonly</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          <p class="text-body-secondary small">
            ...
            plain text, use the <code>plain-text</code> boolean property to remove the default form
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Form Control</strong> <small>File input</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Form Control</strong> <small>Color</small> </CCardHeader>
        <CCardBody>
