      ...
      <CWidgetStatsA color="primary">
        <template #value>
          <div class="d-flex justify-content-between align-items-center gap-2">
            ...
            <h2>Rp. 500.000.000,00</h2>
            <span class="fs-6 fw-normal"> (-12.4% <CIcon icon="cil-arrow-bottom" />) </span>
          </div>
        </template>
        <template #title>Semua uang dalam rekening</template>
        <template #action>
  ...
  <CRow :xs="{ gutter: 4 }" class="mb-3">
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="primary">
        ...
        <template #title>Uang masuk bulan ini</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle color="transparent" class="p-0 text-white" :caret="false">
              <CIcon icon="cil-options" class="text-white" />
    ...
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="info">
        ...
        <template #title>Uang keluar bulan ini</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle color="transparent" class="p-0 text-white" :caret="false">
              <CIcon icon="cil-options" class="text-white" />
    ...
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="warning">
        ...
        <template #title>Uang masuk minggu ini</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle color="transparent" class="p-0 text-white" :caret="false">
              <CIcon icon="cil-options" class="text-white" />
    ...
    <CCol :sm="6" :xl="4" :xxl="3">
      <CWidgetStatsA color="danger">
        ...
        <template #title>Uang keluar minggu ini</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle color="transparent" class="p-0 text-white" :caret="false">
              <CIcon icon="cil-options" class="text-white" />
